 ...
 */
public class OrderAsGuestTest extends BaseTest { //оформить заказ как гость
    @Test
    public void userOrderAsGuestTest(){
        ...
        //заполнить поля как гость
        wait.until(ExpectedConditions.visibilityOfElementLocated(catalogPage.pageLoader));
        wait.until(ExpectedConditions.invisibilityOfElementLocated(catalogPage.pageLoader));
        wait.until(ExpectedConditions.visibilityOfElementLocated(checkoutPage.checkoutAsGuestLabel)).click();
        ...
        driver.findElement(checkoutPage.email).sendKeys("polikarpova.anya@gmail.com");
        ...
        System.out.println("OrderAsGuestTest passed successfully");
    }
}
